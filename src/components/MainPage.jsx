...
const main = forwardRef(() => {
  ...
  const projectsInfos = [
    ...
    },
    {
      ...
      Description:
        "The project showcases various charts and graphs to represent complex data insights. Visually engaging dashboard, with data dynamically fetched from a MySQL database.",
    ...
    },
    {
      ...
      Title: "Grooves",
      Description:
        "This is a ultimate destination for audiophiles and music enthusiasts. Combining sleek design with exceptional soundquality.",
  ...
  return (
    <div>
        ...
        <div className="flex flex-col-reverse mt-2 lg:flex lg:flex-row justify-between lg:mt-20 ">
          ...
          >
            ...
            <p className="font-thin tracking-tighter leading-relaxed mt-5 text-chose-50 lg:mt-8">
              I'm a dedicated and passionate IT graduate with a BTech in
              Information Technology, equipped with hands-on experience in
              diverse tech projects. My academic journey and project work have
              given me a strong foundation in web development. I've developed
              multiple projects, including responsive web applications, data
              visualization tools. I've developed multiple projects, including
              responsive web applications, data visualization tools.
            </p>
          </div>
      ...
      <div className="flex justify-center items-center lg:flex lg:justify-start p-3 lg:p-10 lg:pl-24 lg:-mt-9">
        <a href="https://drive.google.com/file/d/115oca_tIbVv4_l-2CFilE3T6YlCG4Ifk/view?usp=sharing">
          <button
      ...
      <section className="section" id="skill">
        <div className=" section mt-24 lg:mt-32 lg:p-10">
          <div className="flex flex-col justify-center items-center">
            <h1
              className="font-semibold tracking-wider text-4xl"
              data-aos="fade-up"
              data-aos-duration="1000"
            >
              Skills
            ...
            <p
              className="font-light m-3 mt-5 text-chose-50 lg:text-xl"
              data-aos="fade-down"
              data-aos-duration="1000"
            >
      ...
      <section id="projects" className="section">
        <div className="mt-24 lg:mt-32 lg:p-10">
          <div className="flex flex-col justify-center items-center">
            ...
            <p
              className="flex font-light m-3 mt-5 text-chose-50 lg:text-xl"
              data-aos="fade-down"
              data-aos-duration="1000"
            >
      ...
      <section className="mt-20 lg:mt-32 lg:p-10" id="contact">
        ...
        <div
          className="m-5 p-7 bg-chose-20 shadow-black shadow-2xl  rounded-md sm:m-11 md:mx-36 mt-8 2xl:mx-72 2xl:p-9"
